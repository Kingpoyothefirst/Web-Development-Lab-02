...
with st.form("survey_form"):
    ...
    category_input = st.text_input("What day do you walk the most?")
    value_input = st.text_input("How many hours do you walk that day?")
    ...
    if submitted:
        ...
        with open(r"C:\Users\Kofia\Downloads\Web Dev Lab02\Lab02\data.csv", mode = "a", newline = "") as file:
        ...
        st.write(f"You entered: **Walking Day:** {category_input}, **Hours:** {value_input}")
...
if os.path.exists(r"C:\Users\Kofia\Downloads\Web Dev Lab02\Lab02\data.csv") and os.path.getsize(r"C:\Users\Kofia\Downloads\Web Dev Lab02\Lab02\data.csv") > 0:
    # Read the CSV file into a pandas DataFrame.
    current_data_df = pd.read_csv(r"C:\Users\Kofia\Downloads\Web Dev Lab02\Lab02\data.csv")
